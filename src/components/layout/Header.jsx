  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/80 px-6 backdrop-blur-md dark:border-slate-800/50 dark:bg-[var(--color-fin-bg)]/80">
      <div className="flex items-center">
        <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[var(--color-fin-primary)] text-white shadow-sm md:hidden mr-3">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        {/* Currency Toggle */}
        <Button variant="outline" size="sm" onClick={toggleCurrency} className="h-8 px-3 hidden sm:flex text-xs font-semibold hover:border-blue-200 dark:hover:border-blue-800 transition-colors">
        ...
        {/* User Avatar */}
        <button className="h-8 w-8 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-[var(--color-fin-muted)] hover:ring-2 ring-[var(--color-fin-primary)] ring-offset-2 dark:ring-offset-[var(--color-fin-bg)] transition-all">
